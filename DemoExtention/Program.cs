...
namespace DemoExtention
{
    static class StringHelper//using extention mthd we can extend the function
    {//helper class must be static
        public static string FirstCaseChange(this string name)//this' should  
